...
export interface ApiSellYourCarSellYourCar extends Struct.CollectionTypeSchema {
  collectionName: 'sell_your_cars';
  info: {
    displayName: 'SellYourCar';
    pluralName: 'sell-your-cars';
    singularName: 'sell-your-car';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    AskingPrice: Schema.Attribute.Integer &
      Schema.Attribute.Required &
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::sell-your-car.sell-your-car'
    > &
      Schema.Attribute.Private;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    CarMakeAndModel: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 1;
      }>;
    ...
    Phone: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    SelectService: Schema.Attribute.Enumeration<
      [
        'Standard Car Wash & Clean',
        'Tire Care & Wheel Alignment',
        'PPF & Ceramic Coating',
        'Service & Maintenance',
        'Engine & Transmission Repair',
        'Custom Modificatoins & Accessories',
      ]
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiVehicleVehicle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    DriveTrain: Schema.Attribute.Enumeration<['FWD', 'RWD', 'AWD']>;
    EmissionNormCompliance: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 1;
      }>;
    EngineDisplacement: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 1;
      }>;
    EngineVariant: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 1;
      }>;
    ...
    InteriorType: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 1;
      }>;
    ...
    > &
      Schema.Attribute.Private;
    ManufacturingDate: Schema.Attribute.Date;
    MaxPower: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 1;
      }>;
    MaxTorque: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 1;
      }>;
    Name: Schema.Attribute.String &
    ...
    Ownership: Schema.Attribute.Enumeration<
      [
        'First',
        'Second',
        'Third',
    ...
    >;
    PreviousOwner: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 1;
      }>;
    ...
    SeatingCapacity: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    SecondaryFuelType: Schema.Attribute.Enumeration<['Electric']>;
    Sold: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    TopSpeed: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
        },
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::sell-your-car.sell-your-car': ApiSellYourCarSellYourCar;
